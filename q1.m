...
for i = 1:n
 ...
 min_func1 = fmincon(@(s)Vinculo1(L1,L2,H,V,w1,w2,n,s),[xi,yi],[],[],[],[],[0 0],[H V], options);
 ...
 Respsolve = fsolve(@(s)Vinculo2(L1,L2,H,V,w1,w2,n,s),[xi,yi],options);
 %clc
 fprintf('\n============================================================\nAs coordenadas da transição entre as duas linhas são:\n');
 fprintf('\nVia minimizacao: x = %.4f y = %.4f\n',min_func1(1),min_func1(2));
...
[l,h,v,t,a]=catenaria(L,H,V,w,n)
%Função utilizada para minimização
function E=Vinculo1(L1,L2,H,V,w1,w2,n,s)
[l1,h1,v1,t1,a1]=catenaria(L1,s(1),s(2),w1,n);

[l2,h2,v2,t2,a2]=catenaria(L2,H-s(1),V-s(2),w2,n);
...
%da função 'fsolve'.
function R=Vinculo2(L1,L2,H,V,w1,w2,n,s)
[l1,h1,v1,t1,a1]=catenaria(L1,s(1),s(2),w1,n);
